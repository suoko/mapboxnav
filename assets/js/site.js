$(function () {
    ...
    var map = L.mapbox.map('map', 'suoko.jbhn5d4b', {
        tileLayer: {
            detectRetina: true
        },
        zoomControl: true
    ...
    function getDirections(startLng, startLat, finishLng, finishLat, showMapView) {
        ...
        $.ajax({
            ...
            /*url: 'https://api.tiles.mapbox.com/v4/directions/mapbox.driving/' + startLng + ',' + startLat + ';' + finishLng + ',' + finishLat + '.json?access_token=pk.eyJ1Ijoic3Vva28iLCJhIjoicUl0WUpGbyJ9.PHo4BAra3WHDCljdCQ8F6Q',*/
